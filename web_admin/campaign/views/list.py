...
from web_admin.api_settings import GET_CAMPAIGNS, SEARCH_CAMPAIGNS
...
class CampaignList(GroupRequiredMixin, TemplateView, GetHeaderMixin):
    ...
    def _search_for_campaigns(self, body):
        is_success, status_code, status_message, data = RestFulClient.post(url=SEARCH_CAMPAIGNS,
