def get_profile_details_event_list():
    return [{'value': 'active_suspend_reason', 'text': 'Active/Suspend Reason'},
            ...
            {'value': 'contract_extended_date', 'text': 'Agent - Contract Extended Date'},
            ...
            {'value': 'identity_created_timestamp', 'text': 'Identity Created Timestamp'},
            {'value': 'identity_is_deleted', 'text': 'Identity Is Deleted'},
            {'value': 'identity_last_updated_timestamp', 'text': 'Identity Last Updated timestamp'},
            {'value': 'identity_type_id', 'text': 'Identity Type ID'},
            ...
            {'value': 'password_expiry_timestamp', 'text': 'Password Expiry date'},
