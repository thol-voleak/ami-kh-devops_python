...
urlpatterns = [
    ...
    url(r'^(?P<customer_id>[0-9A-Za-z]+)/mobile_devices/(?P<device_id>[0-9A-Za-z]+)/update', login_required(MobileDeviceView.as_view(), login_url='authentications:login'), name="mobile_device_update"),
]
