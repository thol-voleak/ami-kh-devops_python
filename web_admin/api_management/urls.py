...
urlpatterns = [
    ...
    url(r'^apis/$', login_required(APIListView.as_view(), login_url='login'), name="api_list"),
    url(r'^services/$', login_required(ServiceListView.as_view(), login_url='login'), name="service_list"),
]
