...
class RejectVoucherCancelView(TemplateView, GetHeaderMixin):
    logger = logger
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(RejectVoucherCancelView, self).dispatch(request, *args, **kwargs)

    def post(self, request, *args, **kwargs):
        self.logger.info('========== Start reject voucher cancels ==========')
        ...
        self.logger.info('========== Finish reject voucher cancels ==========')
        if is_success:
