...
REGENERATE_CLIENT_SECRET_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/v1/oauths/clients/{}/credentials'
SUSPEND_CLIENT_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/v1/oauths/clients/{}/statuses'
...
DELETE_SYSTEM_USER_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/system-user/v1/users/{}'
UPDATE_SYSTEM_USER_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/system-user/v1/users/{}'
SYSTEM_USER_CHANGE_PASSWORD_URL  = 'https://alp-service-gateway.service.consul:8443/api-gateway/system-user/v1/users/{}'
SERVICE_GROUP_LIST_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-groups'
SERVICE_GROUP_UPDATE_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-groups/{}'
SERVICE_GROUP_DETAIL_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-groups/{}'
ADD_SERVICE_GROUP_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-groups'
SERVICE_LIST_URL='https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/services/'
SERVICE_CREATE_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/services'
SERVICE_DETAIL_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/services/{}'
SERVICE_UPDATE_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/services/{}'
COMPANY_BALANCE_HISTORY = 'https://alp-service-gateway.service.consul:8443/api-gateway/agent/v1/companies/balances/histories/'
GET_AGET_BALANCE = "https://alp-service-gateway.service.consul:8443/api-gateway/agent/v1/agents/{}/balances"
CREATE_COMPANY_BALANCE = "https://alp-service-gateway.service.consul:8443/api-gateway/agent/v1/companies/sofs/{}"
...
COMMAND_LIST_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/commands/'
SERVICE_COMMAND_ADD_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-commands/'
ADD_TIER_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/service-commands/{service_command_id}/fee-tiers/'
FEE_TIER_CONDITION_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/fee-tier-conditions/'
AMOUNT_TYPES_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/amount-types'
COMMAND_LIST_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/commands/'
BALANCE_DISTRIBUTION_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/fee-tiers/{fee_tier_id}/balance-distributions'
ACTION_TYPES_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/action-types'
AMOUNT_TYPES_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/amount-types'
SOF_TYPES_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/sof-types'
ACTOR_TYPES_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/actor-types'
TIER_DETAIL_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/fee-tiers/{fee_tier_id}/balance-distributions'
BALANCE_DISTRIBUTION_DETAIL_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/balance-distributions/{balance_distribution_id}'
BONUS_DISTRIBUTION_URL = 'https://alp-service-gateway.service.consul:8443/api-gateway/payment/v1/fee-tiers/{fee_tier_id}/bonus-distributions'
